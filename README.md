...
* Other frequency waves were tested as well.
  ...
  * An attempt at a sine wave was also made in order to get a more 'note-like' output. Implementation of the wave proved to be time consuming to get perfectly right,as realistically the implementation of a 256 value sine table would need to be added, and any attempt of minimizing values needed for the desired output didn't match the sound we were going for.
